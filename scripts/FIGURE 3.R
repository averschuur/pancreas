...
ggsave("Figure 3DEF_cutoff_vs_predictable_accuracy_02112023.pdf", path= "./plots/", dpi=500)
...
ggsave("Figure3J_correct classification TEST COHORT_02112023.pdf", path= "./plots/", dpi = 500, height = 6, width = 5.5, units = "in")
